<head>
  ...
  <!-- Favicons -->
  <link href="<?php echo base_url()?>assets/assets/images/logo/stmik.png" rel="icon">
  <link href="<?php echo base_url()?>assets/assets/images/logo/stmik.png" rel="apple-touch-icon">
