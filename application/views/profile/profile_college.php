<!-- Page wrapper  -->
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <?php foreach ($users_college as $users ) { ?>
                <!-- Row -->
                <div class="row">
                    <!-- Column -->
                                        ...
                                        <table class="table no-border">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td width="30%" class="font-weight-bold">NIM</td>
                                                    <td><?php echo $users->nim ?></td>
                                                </tr>
                                                <tr>
                                                    <td width="5%"><i class="ti-flickr"></i></td>
            ...
            include(APPPATH.'views/profile/modal_change_profile_college.php'); 
            include(APPPATH.'views/profile/modal_change_photo_college.php'); 
            include(APPPATH.'views/profile/js_profile_college.php'); 
            ?>