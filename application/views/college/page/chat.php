    ...
    <div class="page-wrapper">
                                        ...
                                        <h4 class="card-title">Chat Pesan</h4> 
                                         ...
                                         <div class="ml-auto">
                                            <div class="btn-group m-r-10" role="group" aria-label="Button group with nested dropdown">
                                                 <a href="<?php echo base_url('College/konseling')?>" class="btn btn-outline-secondary " ><i class="mdi mdi-arrow-left-bold"></i></a>
                            ...
                            <div class="card-body border-top">
                                <div class="row">
                                    ...
                                    <div class="col-3">
                                        ...
                                        <form method="POST" action="<?php echo base_url('College/konseling/upload_file')?>" enctype="multipart/form-data"  id="formupload">
                                            <?php foreach ($id_consult as $row ) { ?>
                                                <input type="hidden" value="<?php echo $row->id ?>" name="id_consult" id="id_consult">
                                                <input type="hidden" value="<?php echo $row->nim ?>" name="id_user" id="id_user">
                                            <?php } ?>
      ...
      <?php
        include(APPPATH.'views/college/script/js_chat.php');  
    ?>